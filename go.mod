...
require (
	...
	github.com/nats-io/jwt v2.4.0+incompatible // indirect
	...
	github.com/philchia/agollo/v4 v4.1.4 // indirect
...
replace (
	github.com/micro/cli/v2 v2.1.2 => github.com/urfave/cli/v2 v2.16.3
	github.com/nats-io/jwt v2.4.0+incompatible => github.com/nats-io/jwt v1.2.2
